...
')
     ...
     */ 
        ...
        {
                        /** @var \Yish\Imgur\Upload $instance */
        ...
        public static function version()
        {
                        return \Yish\Imgur\Upload::version();
        }
                    /**
         * Set headers.
         *
         * @param $headers
         * @return \Yish\Imgur\Upload 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function setFormParams($params)
        {
                        /** @var \Yish\Imgur\Upload $instance */
         ...
         * @static 
         */ 
        public static function size($url, $size)
        {
                        /** @var \Yish\Imgur\Upload $instance */
                        return $instance->size($url, $size);
        }
...
namespace  { 
            ...
            class Imgur extends \Yish\Imgur\Facades\Upload {}
